...
Import-Module (Join-Path $corePath 'Bootstrap.psm1') -Force
Import-Module (Join-Path $corePath 'Logging.psm1')  -Force
Import-Module (Join-Path $corePath 'FileCopy.psm1') -Force
Import-Module (Join-Path $corePath 'OneDrive.psm1') -Force
